...
export const environment = {
  ...
  apiUrl: 'https://ibf-pivot.510.global/api', // API
  apiToken:
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..RDGFYZlEsIhmcHMblG8e6SFfyE1nzpFkMnk46XFS8no', // Add your API authentication token here
  useServiceWorker: false, // feature-flags
  geoserverUrl: 'https://ibf.510.global/geoserver/ibf-system/wms', // geoserver
  ibfSystemVersion: 'v0.321.195', // version
