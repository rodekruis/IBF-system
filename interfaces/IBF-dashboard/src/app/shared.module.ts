...
import { CommunityNotificationPhotoPopup } from './components/community-notification-photo-popup/community-notification-photo-popup.component';
...
@NgModule({
  ...
  declarations: [
    ...
    CommunityNotificationPhotoPopup,
    DateButtonComponent,
