...
**Problem**: Browser blocking requests from localhost:4200 to https://ibf-test.510.global/api
...
#### proxy.conf.json
Proxies `/api/*` requests to `https://ibf-test.510.global` to avoid CORS issues during development.
