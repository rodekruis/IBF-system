...
(function() {
    console.log('🎯 IBF Dashboard Template: Script started');
    console.log('🎯 IBF Dashboard Template: DOM readyState:', document.readyState);
    ...
    function loadWebComponentAssets() {
        ...
        console.log('📦 Assets base path:', '/client/custom/modules/ibf-dashboard/assets');
        ...
        loadCSS(`${assetsBase}/ibf-dashboard.css`)
            .then(() => {
                ...
                return loadJS(`${assetsBase}/ibf-dashboard-bundle.min.js`);
            })
            .then(() => {
    ...
    if (document.readyState === 'loading') {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('🎯 DOMContentLoaded fired, calling loadWebComponentAssets...');
            loadWebComponentAssets();
        });
    } else {
        console.log('🎯 DOM already ready, calling loadWebComponentAssets immediately...');
        loadWebComponentAssets();
    }
})();
</script>
