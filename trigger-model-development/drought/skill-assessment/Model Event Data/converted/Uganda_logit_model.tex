...
\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.2\paperheight}{Uganda_logit_model_files/output_52_0.png}\end{center}\caption{Histogram of the number of droughts per year in the (reduced) data.
...
\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.22\paperheight}{Uganda_logit_model_files/output_54_0.png}\end{center}\caption{F1 score for the positive class as a function of the regularization
...
\begin{figure}[b]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.27\paperheight}{Uganda_logit_model_files/output_61_0.png}\end{center}\caption{Precision-recall curve (left) and receiver operating characteristic
...
\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.17\paperheight}{Uganda_logit_model_files/output_68_0.png}\end{center}\caption{Distribution of the drought score separated by the label values.}\label{fig_score}\end{figure}
...
\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.2\paperheight}{Uganda_logit_model_files/output_70_0.png}\end{center}\caption{Number of reported droughts in Uganda during each harvest season between
...
\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.3\paperheight}{Uganda_logit_model_files/output_72_0.png}\end{center}\caption{Model scores for Uganda districts in the first harvest season in 2009.
...
\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.3\paperheight}{Uganda_logit_model_files/output_73_0.png}\end{center}\caption{Model scores for Uganda districts in the first harvest season in 2011.
The colorbar is capped at +/- 0.6. Stars mark districts in which a
drought has been reported. The model successfully captures the droughts.}\label{fig_map2011}\end{figure}

\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.3\paperheight}{Uganda_logit_model_files/output_74_0.png}\end{center}\caption{Model scores for Uganda districts in the second harvest season in 2016.
The colorbar is capped at +/- 0.6. Stars mark districts in which a
drought has been reported. The model successfully captures the droughts.}\label{fig_map2016}\end{figure}

\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.3\paperheight}{Uganda_logit_model_files/output_75_0.png}\end{center}\caption{Model scores for Uganda districts in the first harvest season in 2017.
The colorbar is capped at +/- 0.6. Stars mark districts in which a
...
\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.3\paperheight}{Uganda_logit_model_files/output_77_0.png}\end{center}\caption{Model scores for Uganda districts in the first harvest season in 2013.
The colorbar is capped at +/- 0.6. Stars mark districts in which a
drought has been reported. The model fails to capture the droughts.}\label{fig_map2013a}\end{figure}

\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.3\paperheight}{Uganda_logit_model_files/output_79_0.png}\end{center}\caption{The same as \ref{fig_map2013a}, but the score is calculated by averaging
...
\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.2\paperheight}{Uganda_logit_model_files/output_83_0.png}\end{center}\caption{Number of droughts in Uganda during each month between 2000 and 2019.
...
\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.22\paperheight}{Uganda_logit_model_files/output_92_0.png}\end{center}\caption{Correlation of the normalized \(\Delta\)DMP with the drought score
...
\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.25\paperheight}{Uganda_logit_model_files/output_96_0.png}\end{center}\caption{Distribution of the drought score (left) and normalized \(\Delta\)DMP
(right) across Uganda districts in January 2017.}\label{fig_dmp_2017}\end{figure}

\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.25\paperheight}{Uganda_logit_model_files/output_97_0.png}\end{center}\caption{Timeseries of the drought score (blue) and normalized \(\Delta\)DMP
(orange) for ``ABIM'' district.}\label{fig_dmp_abim}\end{figure}

\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.25\paperheight}{Uganda_logit_model_files/output_98_0.png}\end{center}\caption{Correlation coefficients of the normalized \(\Delta\)DMP with the
drought score across Uganda districts.}\label{fig_dmp_corr_districts}\end{figure}

\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight},height=0.25\paperheight}{Uganda_logit_model_files/output_99_0.png}\end{center}\caption{Distribution of the correlation coefficients of the normalized
