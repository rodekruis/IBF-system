...
export class NotificationLogEntity1783613620760 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "IBF-app"."notification-log" ("notificationLogId" uuid NOT NULL DEFAULT uuid_generate_v4(), "channel" "IBF-app"."notification-log_channel_enum" NOT NULL, "userIds" uuid array NOT NULL, "countryCodeISO3" character varying NOT NULL, "disasterType" character varying NOT NULL, "eventNames" character varying array NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_8e0da1d4036a1085a56d6b2a032" PRIMARY KEY ("notificationLogId"))`,
    );
  }
