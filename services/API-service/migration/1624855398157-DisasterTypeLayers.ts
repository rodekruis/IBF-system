...
export class DisasterTypeLayers1624855398157 implements MigrationInterface {
    name = 'DisasterTypeLayers1624855398157'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "IBF-app"."indicator-metadata" ADD "disasterType" character varying`);
        await queryRunner.query(`ALTER TABLE "IBF-app"."layer-metadata" ADD "disasterType" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "IBF-app"."admin-area"."geom" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "IBF-app"."lead-time"."created" IS NULL`);
        await queryRunner.query(`ALTER TABLE "IBF-app"."layer-metadata" DROP COLUMN "disasterType"`);
        await queryRunner.query(`ALTER TABLE "IBF-app"."indicator-metadata" DROP COLUMN "disasterType"`);
    }
