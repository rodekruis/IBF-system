...
export class EventService {
    ...
    private async updateExistingEventAreas() {
        ...
        const affectedAreasPlaceCodes = affectedAreas.map(
            area => area.placeCode,
        );
        ...
        unclosedEventAreas.forEach(unclosedEventArea => {
            if (affectedAreasPlaceCodes.includes(unclosedEventArea.placeCode)) {
                ...
                unclosedEventArea.populationAffected =
                    affectedArea.populationAffected;
                unclosedEventArea.endDate = this.getEndDate(
                    affectedArea.leadTime,
                );
            }
        });
