...
SELECT t0.id
	...
	, t1."date" 
	, t0."countryCode" as country_code
...
;
--select * from "IBF-pipeline-output".triggers_rp_per_station;
...
LEFT JOIN "IBF-pipeline-output".triggers_rp_per_station t1 
	ON t0."stationCode" = t1."stationCode"
...
LEFT JOIN "IBF-pipeline-output".dashboard_forecast_per_station t1 
	ON t0."glofasStation" = t1.station_code
    and t0."countryCode" = t1.country_code
