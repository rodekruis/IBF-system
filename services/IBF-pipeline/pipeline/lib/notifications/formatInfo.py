...
def formatInfo(info, countryCode):
    ...
    for districtInfo in info['data']:
        if districtInfo[2] == '3-day':
            ...
            table3Day += '<tr><td>' + districtInfo[0] + '</td><td>' + affectedPopStr + '</td><td>' + districtInfo[3] + '</td></tr>'
    ...
    for districtInfo in info['data']:
        if districtInfo[2] == '7-day':
            ...
            stringDistrict = districtInfo[0]
            stringList.append(stringDistrict)
            table7Day += '<tr><td>' + districtInfo[0] + '</td><td>' + affectedPopStr + '</td><td>' + districtInfo[3] + '</td></tr>'
    ...
    htmlEmail = htmlTemplate.replace(placeholderToday, today) \
